...
class RefineNet(nn.Module):
    def __init__(self, in_channels, hidden_channels = (64, 128, 256, 512), n_noise_scale=10):
        ...
        self.up_conv = nn.ConvTranspose2d(hidden_channels[-4], hidden_channels[-4], kernel_size=3, stride=2, padding=1,
                                          output_padding=1)
...
if __name__ == "__main__":
    ...
    t = torch.randint(0, 10, (4,), device=device)
